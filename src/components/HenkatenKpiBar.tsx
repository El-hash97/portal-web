  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 pl-1 sm:pl-2 w-full sm:w-auto">
        <span className="w-1.5 h-1.5 rounded-full" style={{ background: '#10B981', boxShadow: '0 0 0 3px rgba(16,185,129,0.2)' }} />
        ...
        {items.map((it, i) => (
          <div key={it.label} className="flex items-center gap-2 sm:gap-3">
            ...
            {i === 0 ? (
              ...
              <div className="w-7 h-7 rounded-full flex items-center justify-center shrink-0" style={{ background: it.bg }}>
