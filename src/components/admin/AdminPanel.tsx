          ...
          <div className="flex items-start sm:items-center justify-between gap-4 mb-6 flex-col sm:flex-row">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <AppWindow size={16} style={{ color: '#EB0A1E' }} />
      ...
      {activeTab === 'komentar' && (
        <>
          <div className="flex items-center gap-2 mb-6">
            <MessageSquare size={16} style={{ color: '#EB0A1E' }} />
            <h2 className="text-[20px] font-bold tracking-tight" style={{ color: 'rgba(255,255,255,0.92)' }}>Pantau Komentar</h2>
          </div>
